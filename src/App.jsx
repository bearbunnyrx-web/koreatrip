...
const itineraryDays = [
  ...
  itineraryDay({
    ...
    stops: [
      ...
      { time: '15:30', title: '고덕 cafe / convenience-store backup', detail: 'If family timing or jet lag creates a blank window, use a nearby cafe, Paris Baguette/Tous Les Jours, or convenience-store snack run instead of wandering hungry.', neighborhood: '고덕역 / parents’ home area', type: 'meal' },
    ...
    mapTargets: [
      ...
      mapTarget('고덕역 카페거리', 'Arrival-day cafe / convenience-store backup zone', { query: '고덕역 카페' }),
    ],
  }),
  itineraryDay({
    key: 'may-17',
  ...
  itineraryDay({
    ...
    stops: [
      ...
      { time: '17:00', title: 'Gujwa cafe backup before Seongsan', detail: 'If the east loop has dead time or weather turns, use a Gujwa/Pyeongdae ocean-view cafe stop before committing to Seongsan.', neighborhood: 'Gujwa / Pyeongdae', type: 'meal' },
    ...
    mapTargets: [
      ...
      mapTarget('구좌읍 오션뷰 카페', 'Gujwa cafe backup before Seongsan', { query: '구좌읍 오션뷰 카페' }),
  ...
  itineraryDay({
    ...
    stops: [
      ...
      { time: '16:45', title: 'Lotte World Mall reset backup', detail: 'If check-in is delayed or you need a no-language-barrier filler, use the mall/cafe/department-store loop next to Sofitel before 본연.', neighborhood: 'Jamsil / Lotte World Mall', type: 'shopping' },
  ...
  itineraryDay({
    ...
    stops: [
      ...
      { time: '12:00', title: 'Wumok Hanwoo omakase lunch', detail: 'Inspiration-tab special-meal pick: 우목 10-course Hanwoo omakase. This becomes the main food anchor of the open Seoul day.', neighborhood: 'Gangnam / Apgujeong', type: 'meal' },
      { time: '14:00', title: 'Apgujeong shopping + cafe backup', detail: 'After 우목, keep the afternoon in one easy Apgujeong/Rodeo cluster: gentle shopping, cafe, and photo-friendly streets if no bigger activity is booked.', neighborhood: 'Apgujeong Rodeo / Cheongdam', type: 'shopping' },
      { time: '17:00', title: 'Hotel reset / outfit change buffer', detail: 'Return or pause before dinner so the evening does not feel like a continuous forced march.', neighborhood: 'Jamsil / Seoul base', type: 'hotel' },
      { time: '19:00', title: 'Myeongdong Kyoja dinner backup', detail: 'If no special dinner is booked, this is the no-brainer Korea classic: easy ordering, fast turnover, and strong Dr. Ho-friendly default.', neighborhood: 'Myeongdong', type: 'meal' },
    ],
    mapTargets: [
      ...
      mapTarget('Apgujeong Rodeo', 'Apgujeong shopping + cafe backup cluster', { query: '압구정로데오' }),
      mapTarget('Myeongdong Kyoja', 'No-brainer dinner backup if no reservation is booked', { query: '명동교자 본점' }),
  ...
  itineraryDay({
    ...
    stops: [
      ...
      { time: '13:30–17:30', title: 'Myeongdong main shopping route', detail: 'Main final sweep: Giordano clothes for Dr. Cho, then skincare/makeup and snacks for Dr. Ho before packing.', neighborhood: 'Myeongdong', type: 'shopping' },
